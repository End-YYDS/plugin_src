...
function fr() {
  if (Oe) return D;
  Oe = 1;
  var M = we, C = Symbol.for("react.element"), U = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, F = M.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function P(b, c, T) {
    ...
    return { $$typeof: C, type: b, key: E, ref: W, props: h, _owner: F.current };
  }
...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var M = we, C = Symbol.for("react.element"), U = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), F = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), P = Symbol.for("react.provider"), b = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), E = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), Q = Symbol.iterator, Ce = "@@iterator";
    function Pe(e) {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === I || Fe || e === F || e === T || e === p || Ae || e === W || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === h || e.$$typeof === P || e.$$typeof === b || e.$$typeof === c || // This needs to include all possible module reference object
...
var dr = Z.exports;
const pr = () => /* @__PURE__ */ dr.jsx("div", { children: "helloWorld" });
export {
  pr as default
};
